...
- **Snowcubes/Moussey consignment:** clean Snowcubes `origin/main@f3f877ee`
...
- **Security:** Snowcubes PR #1567 is at `48121626`; current public main is
  `f3f877eed`, and the branch remains the lockfile-only repair against the
