...
REQUIRED_FILES = {
    ...
    "bin/vidux",
    "bin/vidux-browse",
    "benchmarks/harness/fixtures/durable/PLAN.md",
    "benchmarks/harness/fixtures/interrupted/PLAN.md",
    "benchmarks/harness/fixtures/manifest.json",
    "benchmarks/harness/fixtures/priority-high/PLAN.md",
    "benchmarks/harness/fixtures/priority-high/evidence/2026-08-01-selected-proof.md",
    "benchmarks/harness/fixtures/priority-low/PLAN.md",
    "benchmarks/harness/fixtures/proof-missing/PLAN.md",
    "benchmarks/harness/fixtures/proof-present/PLAN.md",
    "benchmarks/harness/fixtures/proof-present/evidence/2026-08-01-proof.md",
